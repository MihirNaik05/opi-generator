...
class OpiTraces:
    ...
    def render(self, widget_node, tag_name, traces_model):
        ...
        for widget_type, legend, x_pv, y_pv, yerr_pv, trace_type, line_width, \
            ...
            if widget_type == "xyplot" and yerr_pv is not None:
                et.SubElement(trace_node, "err_pv").text = str(yerr_pv)
